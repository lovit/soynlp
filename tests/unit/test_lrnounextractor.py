...
def test_check_r_features():
    ...
    for test_case in test_cases:
        ...
        pos, common, neg, unk, end = check_r_features(word, refined, pos_features, neg_features, common_features)
        print(f"\nword: {word}\n - before: {features}\n - after:  {refined}")
...
def test_lrnounextractor_usage():
    ...
    nouns = noun_extractor.extract(train_data, exclude_numbers=True, exclude_syllables=True, extract_compounds=True)
